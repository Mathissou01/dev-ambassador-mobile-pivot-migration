...
export type ContentPolicyScreenRouteProp = RouteProp<RootStackParamList, "ContentPolicyScreen"> & {
    params: {
        contentType: string;
    };
};
...
export interface ModalWidgetData<cardInfo extends CardInfo | null> extends PointsData {
    isVisible: boolean;
    onClose: () => void;
