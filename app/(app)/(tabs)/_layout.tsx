...
export default function TabLayout() {
  ...
  return (
    <Tabs
      screenOptions={{
        tabBarActiveTintColor: Colors[colorScheme ?? "light"].tint, // Sert à rien
        tabBarActiveBackgroundColor: "red", // Marche pas
        tabBarInactiveTintColor: "red", // Marche pas
        tabBarInactiveBackgroundColor: "red", // Marche pas
        headerStyle: {
          // Marche pas
      ...
      sceneContainerStyle={{
        // Marche pas
        backgroundColor: "green", // Marche pas
        borderWidth: 4, // Debug
      }}
      tabBar={TabBar}
    >
