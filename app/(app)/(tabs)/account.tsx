...
import Avoir from "@/components/SvgIllustration/BackgroundAvatar/Avoir";
import Suicide from "@/components/SvgIllustration/BackgroundAvatar/Suicide";
import Surprise from "@/components/SvgIllustration/BackgroundAvatar/Surprise";
...
const GetBackgroundComponent = ({
    ...
    switch (tag) {
        ...
        case "avoir":
            return <Avoir {...props} />;
        case "suicide":
            return <Suicide {...props} />;
        case "surprise":
            return <Surprise {...props} />;
        default:
            return null;
    }
};
...
export default function Account(): React.JSX.Element {
    ...
    const handleLocalImageLoadingError = (): void => {
        if (userInfos.email !== null) setAvatarImage(new User(userInfos as unknown as UserType).avatarUri);
    };
    ...
    return (
        ...
        >
            <View style={styles.inScrollContainer}>
                ...
                <View
                    style={[styles.container_polaroid, {marginTop: screenWidth * 0.09}]}
                >
                    <View
                    ...
                    >
                        ...
                        <Text style={[styles.textPolaroid]}>
                            {userInfos?.avatar?.polarText ?? ""}
                        </Text>
                        <View
                            style={[
                                styles.frame,
                                {
                                    borderColor:
                                        themeColor?.isDark === true ? colors.gray500 : colors.white,
                                },
                            ]}
                        />
                    </View>
