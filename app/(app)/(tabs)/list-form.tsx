...
export default function ListFormScreen(): ReactNode {
    ...
    function redirection(idForm: string, guidForm: string, title: string): void {
        router.push({
            pathname: `/(app)/forms/${idForm}`,
            params: {title, guidForm},
        });
    }
                            ...
                            forms.map((item: Form) =>
                                valueSelected.includes(item.evenement?._id ?? "") ? (
                                    <CardForm
                                        ...
                                        redirection={(idForm, guidForm) => redirection(idForm, guidForm, item.name!)}
                                    />
                                ) : null
                            )
                        ) : (
