...
import styles from "@/styles/profil-settings/NotificationEditStyle";
            ...
            <SafeAreaView edges={["left", "right"]}>
                <View style={styles.notifForm}>
                    <View style={styles.horizontalSection}>
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                {mainswitchValue ? (
                                    <BellIcon size={30} color={styleDynamic.icon_color.color} />
                                ) : (
                                    <BellOffIcon size={30} color={styleDynamic.icon_color.color} />
                                )}
                            </View>
                    ...
                    <View style={styles.horizontalSection}>
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                <ClockIcon size={30} color={styleDynamic.icon_color.color} />
                            </View>
                            <View style={styles.textSection}>
                                <Text style={styles.title} lightColor={colors.black} darkColor={colors.gray300}>
                                    Horaires évènement
                    ...
                    <View style={styles.horizontalSection}>
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                <CalendarIcon size={30} color={styleDynamic.icon_color.color} />
                            </View>
                            <View style={styles.textSection}>
                                <Text style={styles.title} lightColor={colors.black} darkColor={colors.gray300}>
                                    Nouveaux évènements
                    ...
                    <View style={styles.horizontalSection}>
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                <PodiumIcon size={30} style={[styleDynamic.icon_color]} />
                            </View>
                            <View style={styles.textSection}>
                                <Text style={styles.title} lightColor={colors.black} darkColor={colors.gray300}>
                                    Niveau Ambassador
                    ...
                    >
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                <ClipboardIcon size={30} style={[styleDynamic.icon_color]} />
                            </View>
                            <View style={styles.textSection}>
                                <Text style={styles.title} lightColor={colors.black} darkColor={colors.gray300}>
                                    Seuil formulaire
                    ...
                    >
                        <View style={styles.contentSection}>
                            <View style={styles.icon}>
                                <CheckCircleIcon size={30} style={[styleDynamic.icon_color]} />
                            </View>
                            <View style={styles.textSection}>
                                <Text style={styles.title} lightColor={colors.black} darkColor={colors.gray300}>
