...
export default function FormScreen(): ReactNode {
    ...
    const guidForm = (
        test.getState().routes[test.getState().index].params as {
            guidForm?: string;
        }
    ).guidForm;
    ...
    // VARIABLES STATES
    useEffect(() => {
        if (guidForm !== undefined)
            HubspotFormsRepo.getById<HubspotForm>(guidForm).then((res) => {
                        ...
                        render={({field}) => {
                            return (
                                ...
                                >
                                    ...
                                    <DropDownTemplate
                                        texts={{
                                            empty: "Aucun choix disponible",
                                            searchPlaceholder: "Chercher dans la liste de choix",
                                            placeholder: "Choisissez une option",
                                            selectedItems: {
                                                1: "Une option sélectionnée",
                                                n: "{count} options sélectionnées",
                                            }
                                        }}
                            ...
                            return (
                                <>
                                    ...
                                    <DateTimePickerTemplate
                                        ...
                                        title={decodeHTML(inputField.label)}
                                    />
                                </>
                            );
                        }}
