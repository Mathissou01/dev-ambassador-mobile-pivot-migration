...
const DropDownTemplate = ({
    ...
    DropDownPicker.addTranslation("FR", {
        PLACEHOLDER: texts?.placeholder ?? "Sélectionnez un élément",
        SEARCH_PLACEHOLDER: texts?.searchPlaceholder ?? "Chercher un formulaire...",
        SELECTED_ITEMS_COUNT_TEXT: {
            1: texts?.selectedItems?.["1"] ?? "Un formulaire sélectionné",
            n: texts?.selectedItems?.n ?? "{count} formulaires sélectionné",
        },
        NOTHING_TO_SHOW: texts?.empty ?? "Aucun formulaire n'est actuellement disponible !",
        ...translation,
    });
