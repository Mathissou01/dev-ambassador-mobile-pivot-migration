...
import {AboutIcon, CheckCircleIcon, CloseCircleIcon, EyeOffIcon, EyeOnIcon, SearchIcon,} from "../IconComponent";
        ...
        <View>
            <TextInput
                ...
                placeholderTextColor={
                    colorTheme?.isDark ?? false ? colors.textDark : colors.textLight
                }
                value={value}
                    ...
                    <View style={styles.validIcon}>
                        {value.length > 0 ? (
                            ...
                            <CloseCircleIcon
                                size={22}
                                color={
                                    colorTheme?.isDark ?? false ? colors.errorDark : colors.error
                                }
                            />
                        )}
                    </View>
            ...
            {secureTextEntry && (
                <View
                    style={[
                        ...
                        {
                            borderLeftColor:
                                colorTheme?.isDark ?? false ? colors.white : colors.black,
                        },
                    ]}
                >
                    <TouchableOpacity
                    ...
                    >
                        {showPassword ?? false ? (
                            <EyeOnIcon
                                size={22}
                                color={
                                    colorTheme?.isDark ?? false ? `${colors.textDark}D4` : "#666"
                                }
                            />
                        ) : (
                            <EyeOffIcon
