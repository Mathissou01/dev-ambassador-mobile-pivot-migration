...
const LiquidPaginationDot = ({
  ...
  strokeWidth,
  bigHeadScale,
}: LiquidLikeProps): React.JSX.Element => {
  ...
  const translateFront = scrollX.interpolate({
    ...
    outputRange: [
      defaultProps.dotSize / 2,
      defaultProps.dotSize + defaultProps.marginHorizontal * 2 + defaultProps.dotSize / 2,
      (defaultProps.dotSize + defaultProps.marginHorizontal * 2) * 2 + defaultProps.dotSize / 2,
    ],
  });
...
export default LiquidPaginationDot;
