...
import { resourceMappingNeck } from "./ressourceMappingNeck";
import { type resourceMappingSkin } from "./ressourceMappingSkin";

interface NeckProps {
  selectedItem11: keyof typeof resourceMappingNeck;
  selectedItem12: keyof typeof resourceMappingSkin;
  setIsLoaded?: () => void;
}

export default function Neck(props: NeckProps) {
  const { selectedItem11, selectedItem12, setIsLoaded } = props;
  ...
  const {
    ...
    texture2,
    texture3,
  } = resourceMappingNeck[selectedItem11] || {};
  ...
  }, [selectedItem11, selectedItem12, obj]);
