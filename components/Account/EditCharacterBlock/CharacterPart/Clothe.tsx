...
import { resourceMappingClothe } from "./ressourceMappingClothe";

interface ClotheProps {
  selectedItem7: keyof typeof resourceMappingClothe;
  setIsLoaded?: () => void;
}

export default function Clothe(props: ClotheProps) {
  const { selectedItem7, setIsLoaded } = props;
  ...
  const { obj: objPath, texture } = resourceMappingClothe[selectedItem7] || {};
