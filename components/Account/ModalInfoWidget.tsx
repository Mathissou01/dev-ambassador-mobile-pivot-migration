...
const ModalInfoWidget = ({
    ...
    if (cardInfo.id === "1") {
        modalContent = (
            ...
            >
                <View
                    style={{flex: 1, justifyContent: "center", paddingHorizontal: 30, gap: 10}}
                ...
                >
                    ...
                    <View lightColor={"transparent"} darkColor={"transparent"}
                        ...
                        <Text bold style={styles.statsTitle}>Évènements</Text>
                        <Text medium style={styles.statsTitle}>{userInfos.stats?.nb_events ?? 0}</Text>
                    </View>

                    <View lightColor={"transparent"} darkColor={"transparent"}
                          style={{flexDirection: "row", justifyContent: "space-between"}}>
                        <Text bold style={styles.statsTitle}>Formulaires envoyés</Text>
                        <Text medium style={styles.statsTitle}>{userInfos.stats?.nb_forms ?? 0}</Text>
                    </View>

                    <View lightColor={"transparent"} darkColor={"transparent"}
                          style={{flexDirection: "row", justifyContent: "space-between"}}>
                        <Text bold style={styles.statsTitle}>Crédits obtenus</Text>
                        <Text medium
                              style={styles.statsTitle}>{(userInfos.stats?.credits ?? 0) + (userInfos?.credits ?? 0)}</Text>
                    </View>

                    <View lightColor={"transparent"} darkColor={"transparent"}
                          style={{flexDirection: "row", justifyContent: "space-between"}}>
                        <Text bold style={styles.statsTitle}>Niveau ambassador</Text>
                        <Text medium style={styles.statsTitle}>{userInfos.stats?.level ?? 0}</Text>
                    </View>
                </View>
            </View>
        );
