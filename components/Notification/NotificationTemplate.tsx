...
import styles from "./NotificationTemplateStyle";
      ...
      case "participation_event":
        ...
        switch (subtype) {
          ...
          case "event_validation":
            message =
              "Ta participation à l'événement " + nameEvent + " est validée";
            break;
          case "event_rejection":
            message =
              "Ta participation à l'événement " + nameEvent + " est refusée";
            break;
          default:
            message =
              "Une action s'est produite te concernant sur l'un des événements";
            break;
        }
        break;
      default:
          ...
          renderRightActions={() => (
            <>
              ...
              <View style={styles.deleteIcon}>
                <DeleteIcon
                  size={30}
                  color={hexToRgbA(colors.errorLight, 0.7)}
                />
              </View>
            </>
          )}
