      ...
      <Svg width={dimension} height={dimension} viewBox="0 0 400 400">
        <Defs>
          <ClipPath id="clipPath">
            <Path d="M237.963 162.037c-20.953-20.952-54.973-20.952-75.926 0-20.952 20.953-20.952 54.973 0 75.926 20.953 20.952 54.973 20.952 75.926 0 20.952-20.953 20.952-54.973 0-75.926zm-34.295 34.295a5.186 5.186 0 010 7.336 5.186 5.186 0 01-7.336 0 5.186 5.186 0 010-7.336 5.186 5.186 0 017.336 0z" />
          </ClipPath>
