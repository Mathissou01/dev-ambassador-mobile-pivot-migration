import { Platform, Dimensions, I18nManager, type PlatformIOSStatic } from "react-native";
...
export const screenAspectRatio =
  screenWidth < screenHeight ? screenHeight / screenWidth : screenWidth / screenHeight;
